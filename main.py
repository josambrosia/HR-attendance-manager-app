...
def _resolve_root() -> Path:
    """Where data/, backups/, config.json live.

    - Frozen .exe (PyInstaller): next to the executable so users find their files
    - Dev source: the project root (parent of this main.py)
    """
